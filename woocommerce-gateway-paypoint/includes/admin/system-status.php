	...
	public function render_system_status_items() {
		...
		if ( 'hosted_cashier' == $this->get_gateway()->integration ) {
			$status_data['wc_pay360_3d_enabled'] = array(
				...
				'label'     => '3D Secure',
				'note'      => 'yes' == $this->get_gateway()->get_option( 'cashier_use_3ds' ) ? __( 'Yes', \WC_Pay360::TEXT_DOMAIN ) : __( 'No', \WC_Pay360::TEXT_DOMAIN ),
				'mark'      => 'yes' == $this->get_gateway()->get_option( 'cashier_use_3ds' ) ? 'yes' : 'error',
				'mark_icon' => '',
			);
