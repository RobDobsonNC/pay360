...
class Pay360_Order {
	...
	public function get_initial_transaction_id() {
		return \WC_Pay360_Compat::get_meta( $this->order, '_wc_pay360_initial_transaction_id' );
	}
	...
	public function save_transaction_id( $value ) {
		...
		$this->order->set_transaction_id( wc_clean( $value ) );
	}
	
	public function save_initial_transaction_id( $value ) {
		\WC_Pay360_Compat::update_meta( $this->order, '_wc_pay360_initial_transaction_id', wc_clean( $value ) );
	}
