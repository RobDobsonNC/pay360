...
class Cashier_Service {
	 ...
	 */
	public function process_repeat_payment( $transaction_id, $arguments = array() ) {
		$process = new Repeats( $this );
		
		$cancel = $process->repeat_payment( $transaction_id, $arguments );
		
		return $this->retrieve_response_body( $cancel, 'repeat' );
	}
