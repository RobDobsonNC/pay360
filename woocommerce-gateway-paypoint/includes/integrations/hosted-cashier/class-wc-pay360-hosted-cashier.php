	...
	public function get_settings() {
		return array(
			'cashier_api_installation_id' => array(
				'title'       => __( 'Installation ID', WC_Pay360::TEXT_DOMAIN ) . ' <span class="required" title="required field">*</span>',
				'type'        => 'text',
				'description' => __( 'The installation ID provided by Pay360 for Hosted Cashier. * Required Field.', WC_Pay360::TEXT_DOMAIN ),
				'default'     => '',
				'class'       => 'integration_hosted_cashier pay360_integration',
			),
			
			'cashier_api_username' => array(
				'title'       => __( 'API Username', WC_Pay360::TEXT_DOMAIN ) . ' <span class="required" title="required field">*</span>',
				'type'        => 'text',
				'description' => __( 'The API Username is provided by Pay360. * Required Field.', WC_Pay360::TEXT_DOMAIN ),
				'default'     => '',
				'class'       => 'integration_hosted_cashier pay360_integration',
			),
			
			'cashier_api_password' => array(
				'title'       => __( 'API Password', WC_Pay360::TEXT_DOMAIN ) . ' <span class="required" title="required field">*</span>',
				'type'        => 'password',
				'description' => __( "The API Password is provided by Pay360. * Required Field.", WC_Pay360::TEXT_DOMAIN ),
			...
			'cashier_transaction_type' => array(
				...
				'css'         => 'min-width:350px;',
				'options'     => array(
					'capture' => __( 'Capture', WC_Pay360::TEXT_DOMAIN ),
					'auth'    => __( 'Authorization Only', WC_Pay360::TEXT_DOMAIN ),
				),
				'default'     => 'capture',
			),
			
			'hosted_cashier_renewals_method' => array(
				'title'       => __( 'Recurring transaction method', WC_Pay360::TEXT_DOMAIN ),
				'type'        => 'select',
				'description' => sprintf( __( "How the plugin will process renewal transactions. %s Tokens: is the old way of processing renewals. It will removed from the API gradually and if your renewals are failing it could be the reason. %s Repeat Transactions (default): is the current way of processing renewals. ", WC_Pay360::TEXT_DOMAIN ), '<br/>', '<br/>' ),
				'class'       => 'chosen_select integration_hosted_cashier pay360_integration',
				'css'         => 'min-width:350px;',
				'options'     => array(
					'token'  => __( 'Tokens (Legacy)', WC_Pay360::TEXT_DOMAIN ),
					'repeat' => __( 'Repeat Transactions', WC_Pay360::TEXT_DOMAIN ),
				),
				'default'     => 'capture',
			),
			...
			'hosted_cashier_3ds_settings' => array(
			...
			'cashier_use_3ds' => array(
				...
				'label'       => __( 'Enable 3D Secure', WC_Pay360::TEXT_DOMAIN ),
				'type'        => 'checkbox',
			...
			'cashier_challenge_requested' => array(
				'title'       => __( 'Challenge Required?', WC_Pay360::TEXT_DOMAIN ),
				'type'        => 'select',
				'description' => sprintf( __( "Choose if you want to require a 3DS challenge from the customers. ", WC_Pay360::TEXT_DOMAIN ), '<br/>', '<br/>' ),
				'class'       => 'chosen_select integration_hosted_cashier pay360_integration',
				'css'         => 'min-width:350px;',
				'options'     => array(
					'NO_PREFERENCE'          => __( 'Let the gateway decide', WC_Pay360::TEXT_DOMAIN ),
					'CHALLENGE_REQUESTED'    => __( 'Require a challenge', WC_Pay360::TEXT_DOMAIN ),
					'NO_CHALLENGE_REQUESTED' => __( "Don't require challenge", WC_Pay360::TEXT_DOMAIN ),
				),
