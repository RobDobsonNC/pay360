	...
	public function get_settings() {
		return array(
			...
			'pp_logo_h'         => array(
				...
				'type'        => 'text',
				'description' => __( "Your logo must be 750 pixels in width by 100 pixels in height and must be sent to support@pay360.com with your account ID and a message to tell them to add this logo to your payment page. Once they have uploaded the image to their secure servers and let you know it is available, you can paste the absolute URL link to it. Example: https://www.domain.com/users/abcdef01/logo.jpg", WC_Pay360::TEXT_DOMAIN ),
				'default'     => '',
				'class'       => 'integration_hosted pay360_integration',
			),
			'mail_customer'     => array(
